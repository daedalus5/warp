...
"""Tile FFT tests with mathdx FFT disabled (cooperative scalar fallback path).
...
shared-memory branch on GPU (or the CPU sequential branch on CPU), exercising
the path that runs whenever Warp is built without libmathdx.
"""
